...
class PatchEmbed(nn.Module):
    ...
    Unlike ViT patch embedding block: (1) input is padded to satisfy window size requirements 
    (2) position embedding is not used.
...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = MLPBlock(hidden_size=dim, mlp_dim=mlp_hidden_dim, dropout_rate=drop)
